...
class ticket_comfirm extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    getListTicket = async () => {
        try {
            ...
            if (data && data.data && data.data.success == 1) {
                ...
                this.setState({ dataTickets: result, dataSearch: dataFilter, total_ticket: total_ticket })
            } else {
        ...
        return (
            <div className='m-[10px] p-[10px] border shadow-md bg-white'>
                <div className='flex items-center justify-between space-x-[5px] space-y-'>
                    <Select disabled defaultValue="1" style={{ width: 140, }}
...
export default withRouter(ticket_comfirm);
